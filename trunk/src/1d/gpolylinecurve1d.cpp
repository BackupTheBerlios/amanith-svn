/****************************************************************************
** $file: amanith/src/1d/gpolylinecurve1d.cpp   0.1.0.0   edited Jun 30 08:00
**
...
GReal GPolyLineCurve1D::Point(const GInt32 Index) const {
...
GError GPolyLineCurve1D::SetPoint(const GInt32 Index, const GReal NewPoint) {
